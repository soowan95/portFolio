  ...
  return (
    <>
      ...
      <CareerBody content={"전산화를 위한 노력, 개발자라는 꿈"}>
        ...
        사용했습니다. 그 당시 개발에 지식이 없던 저는 chat gpt, 구글링을 통해
        해당 기능을 구현했고{" "}
        <ColorStrong color={"purple"}>개발자에 대한 꿈</ColorStrong>을
        키워갔습니다.
      </CareerBody>
      <Element name={"army"}>
      ...
      <CareerBody content={"지역대 인원 보고의 자동화를 꿈꾼 정작장교 시절"}>
        ...
        보고했었습니다. 저는 이를 엑셀 파일로 변경해 자동으로 인원 현황이
        수정되게 하고 싶었습니다. 엑셀 파일로 변경하던 중 내가 필요한 함수들을
