      ...
      <Box className={"desktop-tablet-project-detail"}>
        ...
        <SimpleGrid columns={2} spacing={10} h={"40vh"}>
          <Box>
            ...
            <Box className={"project-detail-check-box"}>
              <motion.div
                initial={{ opacity: 0, x: -10 }}
                animate={{ opacity: 1, x: 0 }}
        ...
        <Box className={"project-detail-check-footer"}>
          프로젝트를 시작하기 전 기획 기간을 길게 설정하여 사용 기술들에 대한
          충분한 이해를 갖겠습니다. 단위 테스트와 통합 테스트를 진행하여
          프로젝트의 완성도를 높이고, 인메모리db를 학습하여 실무적인 인증/인가
          서비스를 구현하겠습니다.
        </Box>
      </Box>
        ...
        <Box>
          ...
          <Box className={"project-detail-check-box"}>
            <motion.div
              ...
              className={"project-detail-check"}
            >
              axios interceptor을 사용하며 cors 오류를 경험하고 해결하는 과정을
              배움
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: -10 }}
            ...
            <motion.div
              ...
              className={"project-detail-check"}
            >
              pathvariable에 #으로 시작하는 변수를 사용하려 시도하며 dns에 대해
              학습함
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: -10 }}
